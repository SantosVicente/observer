  ...
  return (
    <div className="flex flex-col items-center relative justify-center min-h-screen py-2 gap-11 bg-[#0e0101] overflow-hidden">
      ...
      <div className="flex flex-col gap-2 mt-5 items-center">
        ...
        <ScrollAnimation delay={2.2} duration={0.3} y={150}>
          <Title title="Observer" />
        </ScrollAnimation>
      </div>

      <div className="flex items-center justify-center gap-0 md:gap-8">
        <ScrollAnimation delay={3.2} duration={0.3} y={150}>
          <Button
            variant={"outline"}
            onMouseEnter={() => {
              play2();
        ...
        <ScrollAnimation delay={3.5} duration={0.3} y={150}>
          <Link
            href="/login"
            onClick={() => {
              play3();
      ...
      <ScrollAnimation delay={3.7} duration={0.3} y={150}>
