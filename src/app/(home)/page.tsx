    ...
    <div className="flex flex-col items-center relative justify-center min-h-screen py-2 gap-11 bg-[#0e0101] overflow-hidden">
      ...
      <div className="flex items-center justify-center gap-0 md:gap-8">
        ...
        <Link href="/signup">
          <Button
            variant={"outline"}
            className="scale-75 md:scale-100 bg-transparent rounded-sm border-2 w-44 h-14 text-[#ff3332] neon-text font-bold text-lg border-[#ff3332] hover:bg-[#ff3332] hover:text-[#0e0101] hover:border-[#0e0101] hover:scale-110 transform transition-all"
          >
            COMPETITOR
          </Button>
        </Link>
